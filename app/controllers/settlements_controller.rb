class SettlementsController < ApplicationController
  ...
  def create
    ...
    statement = MonthlyStatement.new(current_household, year, month)
    square_up = statement.square_up

    @settlement = current_household.settlements.find_or_initialize_by(year:, month:)
